...
import com.thread.dynamics.facebook.dto.ApplicationConstant;
import com.thread.dynamics.facebook.exception.ErrorResponse;
import com.thread.dynamics.facebook.exception.ServiceException;
    ...
    protected <T, EX extends ServiceException> void validateResponseSuccess(final Response clientResponse, final Class<T> responseType, final Class<EX> exceptionClazz) throws EX {
        ...
        if (statusFamily != Family.SUCCESSFUL) {
            ...
            try {
                ...
                if (exception != null && errorResponse instanceof com.thread.dynamics.facebook.exception.ErrorResponse) {
